...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The company details including logo and CNPJ were not updated or displayed correctly on the Settings screen as required by the test plan.')
