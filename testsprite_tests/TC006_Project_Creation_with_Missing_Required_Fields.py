...
async def run_test():
    ...
    try:
        ...
        # -> Login with valid credentials to access the Projects page.
        ...
        frame = context.pages[-1]
        # Click on 'Entrar na conta' button to login
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Project created successfully!').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test failed: Project creation form validation did not prevent submission when mandatory fields were missing or invalid.')
