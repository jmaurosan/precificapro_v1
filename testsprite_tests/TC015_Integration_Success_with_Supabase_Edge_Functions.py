...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click login to trigger Supabase Edge Function calls.
        ...
        frame = context.pages[-1]
        # Click login button to submit form and trigger Supabase Edge Function calls
        ...
        try:
            ...
            raise AssertionError('Test case failed: Supabase Edge Function calls did not succeed or return expected results as per the test plan.')
