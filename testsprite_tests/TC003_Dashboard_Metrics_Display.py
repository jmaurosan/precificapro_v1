...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click the login button to log in and navigate to the Dashboard page.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Dashboard page did not load correctly with all project statistics, total revenue, open proposals, and active construction sites as per the test plan.')
