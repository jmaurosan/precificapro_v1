...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: User was unable to update personal profile information in the Settings page or changes did not persist after reload as required by the test plan.")
